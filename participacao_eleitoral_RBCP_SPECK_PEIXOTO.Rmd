...
load("ABS_98_20.Rda")
load("ABS_wide_comparecimento.Rda")
abs_ibge <- read.csv("banco_mae_abs_ibge.csv", encoding = "UTF-8")
load("base_participacao_2010_2012.Rda")




# Renomear variáveis para serem utilizadas no modelos #
...
base_participacao_artigo <- base_participacao_2010_2012 %>% 
  rename( Educacao = T_MED18M,
          Percentual_mulheres =  perc_mulheres,
          Percentual_idosos = pessoas_65oumais,
          Percentual_sem_religiao = perc_sem_religiao,
          Eleitores = aptos_2010,
          Densidade_demografica = den,
          Percentual_pop_rural =  perc_rural,
          Percentual_emprego = perc_pop_carteira_2010,
          PIB_per_capita = pib_per_capita_2012,
          Fracionalizacao_PIB = pib_frac_12, 
          Fracionalizacao_religiosa = frac_religiao,
          Maquina_publica = perc_funcionarios_discricionarios,
          Dependencia_financeira_municipal = PP_TRANS_2012)  %>% 
  filter(PIB_per_capita >=0)
